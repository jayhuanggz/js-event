...
/**
 * An instance of EventTarget is an object to fire events and subscribe to events
 */
class EventTarget {
    constructor() {
        var self = this;
     ...
     * @param {*} eventName  
     * @param {*} fn callback
     * @param {*} context specify "this" in callback 
    ...
    once(eventName, fn, context, priority) {
